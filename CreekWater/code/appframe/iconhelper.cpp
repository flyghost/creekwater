...
//修改
#define ApplicationFont ":/ttf/CreekWater/uisource/ttf/fontawesome-webfont.ttf"

IconHelper *IconHelper::self = Q_NULLPTR;
...
{
    int fontId = QFontDatabase::addApplicationFont(ApplicationFont);
