...
//鼠标进入控件的事件
void LightButton::enterEvent(QEvent *e)
{
...
//鼠标离开控件的事件
void LightButton::leaveEvent(QEvent *e)
{
...
void LightButton::mousePressEvent(QMouseEvent *e)
{
...
void LightButton::mouseReleaseEvent(QMouseEvent *)
{
    this->move(this->pos() + QPoint(-2,-2));
}
